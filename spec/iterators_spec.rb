...
before :each do
  ...
  describe "#detect" do
    it "should detect all numbers divisible by 2 and 4" do
        expect(@arr.detect {|num| num % 2 == 0 && num % 4 == 0}).to eq(4)
      end
  end
  ...
  describe "#partition" do
    it "should return an array of partitioned arrays " do
      expect(@arr.partition {|num| num > 3}).to eq([[4,5],[1,2,3]])
    end
  end
  ...
  describe "#one" do
    it "should return true if only one element meets the condition" do
      expect(@arr.one? {|num| num % 5 == 0}).to be(true)
    end
  ...
  describe "#none" do
    ...
    it "should return false if the number is in the array " do
      expect(@arr.none? {|num| num % 3 == 0}).to be(false)
    end
  end
